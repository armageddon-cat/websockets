...
<body>
    ...
    <div id="timeout" data-timeout="0"></div>
    <script>
        var img = new Image;
...
//        var socket = new WebSocket("ws://127.0.0.1:8000");
        ...
        setInterval( function() {
            var timeoutvar = document.getElementById('timeout');
            var timeoutdata = timeoutvar.dataset;
            timeoutdata.timeout = 100;
        } , 100);
        ...
        window.addEventListener('keydown', function (e) {
            ...
            var timeoutvar = document.getElementById('timeout');
            var timeoutdata = timeoutvar.dataset;
            if(timeoutdata.timeout == 100) { // once per 100 milliseconds
